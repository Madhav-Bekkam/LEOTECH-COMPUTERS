...
export const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E] flex flex-col items-center justify-center p-6 relative">
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#8B5CF6] rounded-full blur-[150px] opacity-10 pointer-events-none"></div>
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl relative z-10 animate-[fade-in_0.3s_ease-out]">
        ...
        <h2 className="text-3xl font-space font-bold text-white text-center mb-2">Create New Password</h2>
        <p className="text-slate-400 text-center mb-8">Your new password must be different from previously used passwords.</p>
        ...
        {successMsg ? (
          <div className="bg-green-500/10 border border-green-500/30 text-green-400 p-6 rounded-xl text-center mb-6">
            <h3 className="font-bold mb-2">Password Reset Successful</h3>
            <p className="text-sm">{successMsg}</p>
            <p className="text-sm mt-4 text-slate-400">Redirecting to login...</p>
          </div>
        ) : (
